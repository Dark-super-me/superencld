...
AppId = 3281305  #Replace With Your Own
AppHash = "a9e62ec83fe3c22379e3e19195c8b3f6"   #Replace With Your Own
BotToken = "2084008538:AAEiCsq5z8w25_y542uEZEFZLo22dr76krE"  #Replace With Your Own
...
class Convert:
    def __init__(self, quality, file, outfile):
        if quality == "Compressed":
            self._cmd = 'ffpb -i "{}" -c:v libx265 -crf 30 -preset ultrafast -movflags +faststart "{}" -y'.format(file, outfile)
        else:
